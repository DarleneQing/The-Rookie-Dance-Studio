        ...
        <div className="space-y-2">
          ...
          <div className="grid grid-cols-3 gap-4">
            {[1, 2, 3].map((i) => (
              <div
                key={i}
                className="relative bg-card border border-border/60 rounded-3xl p-5 h-32 animate-pulse"
              />
            ))}
          </div>
        </div>
        <div className="space-y-2">
          ...
          <div className="grid grid-cols-1 gap-4">
            {[1, 2, 3, 4, 5].map((i) => (
              <div
                key={i}
                className="relative bg-card border border-border/60 rounded-3xl p-6 h-24 animate-pulse"
              />
            ))}
          </div>
        </div>
