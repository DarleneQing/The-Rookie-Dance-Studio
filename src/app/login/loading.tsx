  ...
  return (
    <main className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 w-full flex items-center justify-center px-4 pb-12">
        <div className="w-full max-w-md bg-black/40 backdrop-blur-2xl border border-white/20 rounded-[30px] p-8 animate-pulse">
          <div className="h-8 w-48 mx-auto bg-white/20 rounded mb-6" />
