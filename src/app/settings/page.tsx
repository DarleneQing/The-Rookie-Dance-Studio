      ...
      <main id="main-content" className="relative min-h-screen overflow-hidden">
        ...
        <div className="relative z-10 container max-w-lg mx-auto pt-8 pb-8 px-4 space-y-6">
          ...
          <div className="mb-6">
            ...
            <p className="text-foreground/70 font-outfit text-sm mt-2 px-2">
          ...
          {profile.verification_status === 'reupload_required' && (
            <div className="bg-warning/10 backdrop-blur-sm rounded-3xl p-4 border border-warning/20 shadow-lg">
              <div className="flex items-start gap-3">
                <div className="bg-warning/20 rounded-full p-2 flex-shrink-0 mt-0.5">
                  <AlertTriangle className="h-5 w-5 text-warning" />
                </div>
                <div className="flex-1 min-w-0">
                  <h3 className="font-syne font-semibold text-warning text-lg">
                  ...
                  >
                    <button className="mt-3 inline-flex items-center gap-2 bg-warning hover:bg-warning text-white font-outfit font-medium text-sm px-4 py-2 rounded-full transition-colors">
          ...
          <div className="space-y-4">
            <h3 className="font-syne font-semibold text-foreground/90 text-lg px-2">Profile</h3>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-6 border border-white/20 shadow-lg">
              <div className="flex items-center gap-4">
                <div className="relative">
                  ...
                  <AvatarUploadDialog>
                    <button
                      ...
                      className="absolute bottom-0 right-0 bg-rookie-pink rounded-md p-1.5 border border-white/30 shadow-md hover:scale-110 transition-transform min-h-11 min-w-11"
                    >
                ...
                <div className="flex-1">
                  <p className="text-foreground/60 font-outfit text-xs mb-1">Profile Picture</p>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-6 border border-white/20 shadow-lg space-y-4">
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <p className="text-foreground/60 font-outfit text-xs mb-1">Full Name</p>
                ...
                >
                  <button
                    ...
                    className="bg-rookie-pink rounded-md p-2 border border-white/30 shadow-md hover:scale-110 transition-transform mt-0.5 min-h-11 min-w-11"
                  >
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <p className="text-foreground/60 font-outfit text-xs mb-1">Email</p>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <p className="text-foreground/60 font-outfit text-xs mb-1">Date of Birth</p>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <p className="text-foreground/60 font-outfit text-xs mb-1">Phone Number</p>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <p className="text-foreground/60 font-outfit text-xs mb-1">Member Type</p>
          ...
          <div className="space-y-4">
            <h3 className="font-syne font-semibold text-foreground/90 text-lg px-2">Student Status</h3>
            ...
            {profile.verification_status === 'none' || profile.verification_status === 'rejected' ? (
                ...
                <button className="w-full bg-white/10 backdrop-blur-sm rounded-3xl p-4 border border-white/20 shadow-lg flex items-center justify-between hover:bg-white/15 transition-colors">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="text-left">
                      <p className="font-outfit text-foreground/90 font-medium">Verify as Student</p>
                      <p className="text-xs text-foreground/60 font-outfit">Upload student card for verification</p>
                    </div>
                  </div>
              ...
              <div className="w-full bg-success/10 backdrop-blur-sm rounded-3xl p-4 border border-success/20 shadow-lg flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <div className="bg-success/20 rounded-full p-2">
                    <CheckCircle2 className="h-5 w-5 text-success" />
                  </div>
                  <div className="text-left">
                    <p className="font-outfit text-success font-medium">Student Status Verified</p>
                    <p className="text-xs text-success/80 font-outfit">Your student status is confirmed</p>
                  </div>
                </div>
                <div className="bg-success/20 rounded-full px-3 py-1">
                  <span className="text-xs font-outfit text-success font-semibold">VERIFIED</span>
                </div>
              </div>
            ) : profile.verification_status === 'reupload_required' ? (
              <StudentVerificationDialog
                ...
                rejectionReason={profile.rejection_reason}
              >
                <button className="w-full bg-warning/10 backdrop-blur-sm rounded-3xl p-4 border border-warning/20 shadow-lg flex items-center justify-between hover:bg-warning/15 transition-colors">
                  <div className="flex items-center gap-3">
                    <div className="bg-warning/20 rounded-full p-2">
                      <GraduationCap className="h-5 w-5 text-warning" />
                    </div>
                    <div className="text-left">
                      <p className="font-outfit text-warning font-medium">Re-upload Student Card</p>
                      <p className="text-xs text-warning/80 font-outfit">Action required</p>
                    </div>
                  </div>
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div className="text-left">
                <p className="font-outfit text-foreground/90 font-medium">Frequently Asked Questions</p>
              </div>
            </div>
            <svg className="h-5 w-5 text-foreground/60" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <FindUsDialog>
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div className="text-left">
                  <p className="font-outfit text-foreground/90 font-medium">Find Us</p>
                  <p className="font-outfit text-xs text-foreground/60">Location, contact & social media</p>
                </div>
              </div>
              <svg className="h-5 w-5 text-foreground/60 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
              </svg>
            </button>
          </FindUsDialog>
          ...
          <SubscriptionPricingDialog>
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div className="text-left">
                  <p className="font-outfit text-foreground/90 font-medium">Subscription Pricing</p>
                  <p className="font-outfit text-xs text-foreground/60">Class card prices — payment offline</p>
                </div>
              </div>
              <svg className="h-5 w-5 text-foreground/60 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div className="text-left">
                <p className="font-outfit text-foreground/90 font-medium">Terms and Conditions</p>
              </div>
            </div>
            <svg className="h-5 w-5 text-foreground/60" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div className="text-left">
                <p className="font-outfit text-foreground/90 font-medium">Privacy Policy</p>
              </div>
            </div>
            <svg className="h-5 w-5 text-foreground/60" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
          ...
          {/* Account Actions */}
          <div className="space-y-4">
            <h3 className="font-syne font-semibold text-foreground/90 text-lg px-2">Account</h3>
