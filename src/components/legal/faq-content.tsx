      ...
      <div className="mt-12 bg-gradient-to-r from-rookie-purple/20 to-rookie-pink/20 rounded-2xl p-6 border border-white/10">
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          <a
            ...
            className="inline-flex items-center justify-center gap-2 bg-gradient-to-r from-rookie-purple to-rookie-pink hover:opacity-90 text-white font-outfit font-medium px-6 py-3 rounded-xl transition-all"
          >
