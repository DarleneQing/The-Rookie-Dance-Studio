    ...
    <div id="terms-content" className="space-y-8 text-white/90">
      ...
      <section id="scope">
        ...
        <ul className="list-disc list-inside space-y-2 ml-4">
          <li>Register for an account on The Rookie Dance Studio Platform</li>
          <li>Book and participate in dance classes (&quot;Classes&quot;) organized by The Rookie Dance Studio</li>
          <li>Use any features or services provided through the Platform</li>
        </ul>
        <p className="mt-4">
      ...
      <section id="accounts">
        ...
        <ul className="list-disc list-inside space-y-2 ml-4">
          ...
          <li>The Rookie Dance Studio reserves the right to suspend or terminate accounts that violate these Terms</li>
        </ul>
      </section>
      ...
      <section id="fees">
        ...
        <ul className="list-disc list-inside space-y-2 ml-4">
          ...
          <li><strong>5-Times Card:</strong> Valid for 5 class check-ins with no expiration date</li>
        ...
        <ul className="list-disc list-inside space-y-2 ml-4">
          ...
          <li>Users can view their subscription status, remaining balance, and check-in history through their profile</li>
        </ul>
      </section>
      ...
      <section id="cancellation">
        ...
        <ul className="list-disc list-inside space-y-2 ml-4">
          ...
          <li>Full refund of the paid fee</li>
        </ul>
        <p className="mt-4">Refunds will be processed within 14 business days.</p>
      </section>
      ...
      <section id="liability">
        ...
        <ul className="list-disc list-inside space-y-2 ml-4">
          ...
          <li>Participation carries inherent risks including, but not limited to, muscle strains, sprains, falls, collisions, and other injuries</li>
        ...
        <ul className="list-disc list-inside space-y-2 ml-4">
          ...
          <li>Releases the Released Parties from any liability, damages, losses, or expenses arising from participation in Classes</li>
      ...
      <section id="medical">
        ...
        <ul className="list-disc list-inside space-y-2 ml-4">
          ...
          <li>Participant&apos;s insurance must cover any injuries or medical expenses incurred during participation</li>
        </ul>
      </section>
      ...
      <section id="conduct">
        ...
        <ul className="list-disc list-inside space-y-2 ml-4">
          ...
          <li>Respect fellow participants, instructors, and staff</li>
          <li>Maintain a positive, supportive, and inclusive environment</li>
          <li>Refrain from disruptive, unsafe, or inappropriate behavior</li>
        ...
        <ul className="list-disc list-inside space-y-2 ml-4">
          ...
          <li>Use of offensive, abusive, or threatening language</li>
          <li>Intoxication or use of illegal substances</li>
          <li>Unauthorized recording or photography of classes or participants</li>
        ...
        <ul className="list-disc list-inside space-y-2 ml-4">
          ...
          <li>Removal from class without refund</li>
      ...
      <section id="media">
        ...
        <ul className="list-disc list-inside space-y-2 ml-4">
          ...
          <li>A perpetual, royalty-free, worldwide license to use such media for promotional, marketing, educational, and archival purposes</li>
      ...
      <section id="privacy">
        ...
        <ul className="list-disc list-inside space-y-2 ml-4">
          ...
          <li>Profile data (avatar, student verification documents)</li>
        ...
        <ul className="list-disc list-inside space-y-2 ml-4">
          ...
          <li>Class booking and attendance tracking</li>
        ...
        <p className="mt-4">
          For data privacy inquiries, please refer to our <a href="/privacy" className="text-rookie-cyan hover:underline">Privacy Policy</a> or contact therookiestudio.ch@gmail.com.
        </p>
      </section>

      {/* Sections 11-18 - Abbreviated for space */}
      <section id="platform-use">
        <h2 className="font-syne font-bold text-2xl text-white mb-4">11. PLATFORM USE AND RESTRICTIONS</h2>
        <p className="mb-4">
          The Platform is provided for personal, non-commercial use to register and manage user accounts, book and manage class attendance, view subscription status and check-in history, and access profile and QR code for check-in.
        </p>
        <p className="mb-4">
          Users may not use the Platform for any unlawful purpose, attempt to gain unauthorized access, interfere with functionality, use automated systems, impersonate others, or share account credentials.
        </p>
      </section>

      <section id="modifications">
        <h2 className="font-syne font-bold text-2xl text-white mb-4">12. MODIFICATIONS TO TERMS</h2>
        <p className="mb-4">
          The Rookie Dance Studio reserves the right to modify these Terms and Conditions at any time. Changes will be effective upon posting to the Platform. Users will be notified of material changes via email or prominent notice on the Platform.
        </p>
      </section>

      <section id="termination">
        <h2 className="font-syne font-bold text-2xl text-white mb-4">13. TERMINATION</h2>
        <p className="mb-4">
          Users may terminate their account at any time by contacting The Rookie Dance Studio. The Rookie Dance Studio reserves the right to suspend or terminate user accounts for violation of these Terms, fraudulent activity, or abusive behavior.
        </p>
      </section>

      <section id="limitation">
        <h2 className="font-syne font-bold text-2xl text-white mb-4">14. LIMITATION OF LIABILITY</h2>
        <p className="mb-4">
          To the fullest extent permitted by Swiss law, The Rookie Dance Studio&apos;s total liability for any claim shall not exceed the amount paid by the User in the 12 months preceding the claim. The Rookie Dance Studio is not liable for indirect, incidental, consequential, or punitive damages.
        </p>
      </section>

      <section id="governing-law">
        <h2 className="font-syne font-bold text-2xl text-white mb-4">15. DISPUTE RESOLUTION AND GOVERNING LAW</h2>
        <p className="mb-4">
          These Terms and Conditions are governed by and construed in accordance with the laws of Switzerland. Any disputes shall be subject to the exclusive jurisdiction of the competent courts in the canton where The Rookie Dance Studio is registered.
        </p>
      </section>

      <section id="severability">
        <h2 className="font-syne font-bold text-2xl text-white mb-4">16. SEVERABILITY</h2>
        <p className="mb-4">
      ...
      <section id="entire-agreement">
        <h2 className="font-syne font-bold text-2xl text-white mb-4">17. ENTIRE AGREEMENT</h2>
        <p className="mb-4">
      ...
      <section id="contact">
        <h2 className="font-syne font-bold text-2xl text-white mb-4">18. CONTACT INFORMATION</h2>
        <p className="mb-4">
      ...
      {/* Agreement Statement */}
      <div className="bg-rookie-purple/10 border border-rookie-purple/30 rounded-xl p-6 mt-8">
        <p className="text-center font-outfit">
          <strong>By using The Rookie Dance Studio Platform, you acknowledge that you have read, understood, and agree to be bound by these Terms and Conditions.</strong>
        </p>
      </div>
    </div>
  )
